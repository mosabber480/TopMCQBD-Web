...
export default function DBPaidAdminPage() {
  ...
  return (
    <DbAuthGuard activeRoute="/db-connection/dbpaid-admin">
      ...
      <div className="db-content-card">
        ...
        <div className="crud-container">
          <div className="crud-header">
            ...
            <p>নিচের বক্সে টেক্সট লিখে যোগ করুন। এটি সরাসরি Paid MongoDB ক্লাস্টারে সেভ হবে এবং <code>/db-connection/dbpaid-test</code> পেজে লাইভ আপডেট হবে।</p>
          </div>
        ...
        <DbNavBox activeRoute="/db-connection/dbpaid-admin" />
