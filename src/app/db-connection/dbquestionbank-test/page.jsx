...
const CACHE_KEY = 'topmcqbd_dbquestionbank_test_cache';

export default function DBQuestionBankTestPage() {
  ...
  const fetchData = useCallback(
    async (forceRefresh = false) => {
      ...
      try {
        ...
        const res = await fetch(`${baseUrl}/api/db-test/question-bank`, {
          method: 'GET',
          cache: 'no-store',
        ...
        setError(err.message || 'Failed to fetch items from Question Bank Database');
      } finally {
        setLoading(false);
      }
    },
  ...
  return (
    <DbAuthGuard activeRoute="/db-connection/dbquestionbank-test">
      <main className="db-page-container">
        <div className="db-content-card">
          {/* Header */}
          <div className="db-header">
            <div className="db-badge">
              Question Bank Paid DB Live Viewer
            </div>
            <h1 className="db-title">Question Bank Database Live Data</h1>
            <p className="db-subtitle">
              Question Bank Cluster (<strong>TopMCQBD_DB_Question_Bank</strong>) এর <code>db-question-bank-test</code> কালেকশনের রিয়েল-টাইম সংরক্ষিত ডাটা
            </p>
          ...
          <div className="summary-grid">
            <div className="summary-card">
              ...
              <strong className="summary-val" style={{ color: '#60a5fa' }}>TopMCQBD_DB_Question_Bank</strong>
            </div>
            <div className="summary-card">
              <span className="summary-label">টার্গেট কালেকশন</span>
              <strong className="summary-val" style={{ color: '#38bdf8' }}>db-question-bank-test</strong>
            </div>
            <div className="summary-card">
          ...
          <div className="data-cards-section">
            {loading && items.length === 0 ? (
              <div className="empty-box">
                ...
                <span>Question Bank Database থেকে ডাটা লোড হচ্ছে...</span>
              </div>
            ) : items.length === 0 ? (
              <div className="empty-box">
                ...
                <p style={{ margin: '0 0 16px 0' }}><code>db-question-bank-test</code> কালেকশনে এখনো কোনো ডাটা যোগ করা হয়নি।</p>
                <Link
                  href="/db-connection/dbquestionbank-admin"
          ...
          <DbNavBox activeRoute="/db-connection/dbquestionbank-test" />
