...
export default function DBSubjectiveAdminPage() {
  ...
  const fetchSubjectiveData = useCallback(async () => {
    setLoading(true);
    setFetchError(null);
    try {
      const baseUrl = getApiUrl();
      const endpoint = `${baseUrl}/api/db-test/subjective`;
      ...
      setFetchError(
        `${err.message || 'Failed to connect'}. (নিশ্চিত করুন সার্ভার চালু আছে ও .env ফাইলে MONGODB_URI_SUBJECTIVE সঠিক রয়েছে।)`
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <DbAuthGuard activeRoute="/db-connection/dbsubjective-admin">
      <main className="db-page-container">
        <div className="db-content-card">
          {/* Header */}
          <div className="db-header">
            <div className="db-badge" style={{ background: '#fdf4ff', color: '#a855f7', borderColor: '#f0abfc' }}>
              Subjective Admin Diagnostic & Manager
            </div>
            <h1 className="db-title">Subjective MCQs Database Manager</h1>
            <p className="db-subtitle">
              Subjective Cluster (<strong>TopMCQBD_DB_Subjective</strong>) ও <code>db-subjective-test</code> কালেকশন ম্যানেজমেন্ট ও লাইভ ডায়াগনস্টিক
            </p>
          ...
          <div className="db-control-bar">
            ...
            <div className="control-btn-group">
              <button onClick={fetchSubjectiveData} disabled={loading} className="recheck-btn" style={{ background: '#9333ea' }}>
                {loading ? (
                  <>
          ...
          <div className="db-grid" style={{ gridTemplateColumns: '1fr', marginBottom: '24px' }}>
            <div className={`status-card ${statusData?.connected ? 'card-success' : 'card-danger'}`}>
              <div className="card-header">
                <div>
                  <div className="card-type-tag" style={{ color: '#9333ea' }}>Subjective Paid Cluster</div>
                  <div style={{ fontSize: '12px', color: '#94a3b8', marginTop: '3px' }}>
                    টার্গেট কালেকশন: <strong style={{ color: '#a855f7' }}>db-subjective-test</strong>
                  </div>
                </div>
              ...
              <h3 className="card-db-name">
                <i className="fa-solid fa-folder" style={{ marginRight: '8px', color: '#a855f7' }} />
              ...
              <div className="meta-list">
                ...
                <div className="meta-row">
                  <span className="meta-label">db-subjective-test কালেকশনে মোট ডাটা:</span>
                  <span className="meta-value" style={{ color: '#a855f7', fontSize: '15px' }}>
          ...
          <div className="crud-container">
            <div className="crud-header">
              <h3>
                <i className="fa-solid fa-pen-nib" style={{ marginRight: '8px', color: '#a855f7' }} />
                ডাটা যোগ ও সম্পাদনা প্যানেল (db-subjective-test)
              </h3>
              <p>নিচের বক্সে টেক্সট লিখে যোগ করুন। এটি সরাসরি Subjective MongoDB ক্লাস্টারে সেভ হবে এবং <code>/db-connection/dbsubjective-test</code> পেজে লাইভ আপডেট হবে।</p>
            </div>
            ...
            <div className="summary-grid">
              <div className="summary-card">
                ...
                <strong className="summary-val" style={{ color: '#a855f7' }}>
                  {statusData?.cluster || 'TopMCQBD_DB_Subjective'}
                </strong>
              </div>
              <div className="summary-card">
              ...
              {!isAddingData ? (
                ...
                <div className="add-rows-container">
                  <div className="add-rows-header">
                    <span className="add-rows-title" style={{ color: '#9333ea' }}>
                      <i className="fa-solid fa-layer-group" style={{ marginRight: '8px', color: '#9333ea' }} />
                      নতুন ডাটা যোগ করুন:
                    </span>
                  </div>
                  ...
                  <div className="add-rows-list">
                    {newDataRows.map((row, rIdx) => (
                      <div key={rIdx} className="add-row-item">
                        <span className="row-num-badge" style={{ background: '#faf5ff', color: '#9333ea' }}>#{rIdx + 1}</span>
                        <input
                          type="text"
          ...
          <DbNavBox activeRoute="/db-connection/dbsubjective-admin" />
