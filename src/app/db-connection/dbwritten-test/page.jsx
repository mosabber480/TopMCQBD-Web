...
const CACHE_KEY = 'topmcqbd_dbwritten_test_cache';

export default function DBWrittenTestPage() {
  ...
  const fetchData = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to fetch items from Written Exam Database');
    } finally {
      setLoading(false);
    }
  }, [getApiUrl]);
  ...
  return (
    <DbAuthGuard activeRoute="/db-connection/dbwritten-test">
        ...
        <div className="db-content-card">
          ...
          <div className="db-header">
            ...
            <p className="db-subtitle">
              Written Exam Cluster (<strong>TopMCQBD_DB_written</strong>) এর <code>db-written-test</code> কালেকশনের রিয়েল-টাইম সংরক্ষিত ডাটা
            </p>
          ...
          <div className="summary-grid">
            <div className="summary-card">
              ...
              <strong className="summary-val" style={{ color: '#60a5fa' }}>TopMCQBD_DB_written</strong>
            </div>
            <div className="summary-card">
          ...
          <div className="data-cards-section">
            {loading && items.length === 0 ? (
              <div className="empty-box">
                ...
                <span>Written Exam Database থেকে ডাটা লোড হচ্ছে...</span>
              </div>
            ) : items.length === 0 ? (
              <div className="empty-box">
                ...
                <p style={{ margin: '0 0 16px 0' }}><code>db-written-test</code> কালেকশনে এখনো কোনো ডাটা যোগ করা হয়নি।</p>
                <Link
                  href="/db-connection/dbwritten-admin"
          ...
          <DbNavBox activeRoute="/db-connection/dbwritten-test" />
