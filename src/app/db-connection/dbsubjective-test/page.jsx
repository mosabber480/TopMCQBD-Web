...
const CACHE_KEY = 'topmcqbd_dbsubjective_test_cache';

export default function DBSubjectiveTestPage() {
  ...
  const fetchData = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      setError(err.message || 'Failed to fetch items from Subjective MCQs Database');
    } finally {
      setLoading(false);
    }
  }, [getApiUrl]);
  ...
  return (
    <DbAuthGuard activeRoute="/db-connection/dbsubjective-test">
        ...
        <div className="db-content-card">
          ...
          <div className="db-header">
            ...
            <p className="db-subtitle">
              Subjective Cluster (<strong>TopMCQBD_DB_Subjective</strong>) এর <code>db-subjective-test</code> কালেকশনের রিয়েল-টাইম সংরক্ষিত ডাটা
            </p>
          ...
          <div className="data-cards-section">
            {loading && items.length === 0 ? (
              <div className="empty-box">
                ...
                <span>Subjective Database থেকে ডাটা লোড হচ্ছে...</span>
              </div>
            ) : items.length === 0 ? (
              <div className="empty-box">
                ...
                <p style={{ margin: '0 0 16px 0' }}><code>db-subjective-test</code> কালেকশনে এখনো কোনো ডাটা যোগ করা হয়নি।</p>
                <Link
                  href="/db-connection/dbsubjective-admin"
          ...
          <DbNavBox activeRoute="/db-connection/dbsubjective-test" />
