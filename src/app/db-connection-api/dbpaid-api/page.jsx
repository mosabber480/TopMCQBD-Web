...
const DB_CONFIG = {
  ...
  hostName: 'topmcqbd-paid-api.onrender.com',
  apiEndpoint: '/api/db-test/paid',
};
...
export default function DbPaidPage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/dbpaid-api">
      <DbPaidContent />
    </DbAuthGuard>
  );
}

function DbPaidContent() {
  ...
  return (
    <main className="workers-api-container">
      <div className="workers-api-wrapper">
        ...
        <DbNavBox activeRoute="/db-connection-api/dbpaid-api" />
      </div>
