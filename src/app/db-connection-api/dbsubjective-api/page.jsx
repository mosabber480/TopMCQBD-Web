...
const DB_CONFIG = {
  ...
  hostName: 'subjective-paid-api.onrender.com',
  apiEndpoint: '/api/db-test/subjective',
};
...
export default function DbSubjectivePage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/dbsubjective-api">
      <DbSubjectiveContent />
    </DbAuthGuard>
  );
}

function DbSubjectiveContent() {
  ...
  const fetchDbData = useCallback(async (isManual = false) => {
    ...
    try {
      ...
      const data = json.subjectiveDb || json;
  ...
  return (
    <main className="workers-api-container">
      <div className="workers-api-wrapper">
        ...
        <DbNavBox activeRoute="/db-connection-api/dbsubjective-api" />
      </div>
