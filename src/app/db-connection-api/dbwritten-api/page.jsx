...
const DB_CONFIG = {
  ...
  hostName: 'written-paid-api.onrender.com',
  apiEndpoint: '/api/db-test/written',
};
...
export default function DbWrittenPage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/dbwritten-api">
      <DbWrittenContent />
    </DbAuthGuard>
  );
}

function DbWrittenContent() {
  ...
  const fetchDbData = useCallback(async (isManual = false) => {
    ...
    try {
      ...
      const data = json.writtenDb || json;
  ...
  return (
    <main className="workers-api-container">
      <div className="workers-api-wrapper">
        ...
        <DbNavBox activeRoute="/db-connection-api/dbwritten-api" />
      </div>
