...
const DB_CONFIG = {
  ...
  hostName: 'topmcqbd-free-api.onrender.com',
  apiEndpoint: '/api/db-test/free',
};
...
export default function DbFreePage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/dbfree-api">
      <DbFreeContent />
    </DbAuthGuard>
  );
}

function DbFreeContent() {
  ...
  return (
    <main className="workers-api-container">
      <div className="workers-api-wrapper">
        ...
        <DbNavBox activeRoute="/db-connection-api/dbfree-api" />
      </div>
