...
const DB_CONFIG = {
  ...
  hostName: 'question-bank-paid-api.onrender.com',
  apiEndpoint: '/api/db-test/question-bank',
};
...
export default function DbQuestionBankPage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/dbquestionbank-api">
      <DbQuestionBankContent />
    </DbAuthGuard>
  );
}

function DbQuestionBankContent() {
  ...
  const fetchDbData = useCallback(async (isManual = false) => {
    ...
    try {
      ...
      const data = json.questionBankDb || json;
  ...
  return (
    <main className="workers-api-container">
      <div className="workers-api-wrapper">
        ...
        <DbNavBox activeRoute="/db-connection-api/dbquestionbank-api" />
      </div>
