...
export default function DbTestPagesApiPage() {
  return (
    <DbAuthGuard activeRoute="/db-connection-api/db-test-pages-api">
      <DbTestPagesApiContent />
    </DbAuthGuard>
  );
}

function DbTestPagesApiContent() {
  ...
  const apiBaseDomain = 'https://topmcqbd-web-deploy-test.pages.dev';
      ...
      <div className="pages-api-wrapper">
        ...
        <div className="breadcrumb-bar">
          <div className="breadcrumb-links">
            ...
            <span className="bc-sep">/</span>
            <span className="bc-active">Cloudflare Test Pages API Suite (All MongoDB)</span>
          </div>
        </div>
        ...
        <div className="top-api-master-box">
          <div className="top-box-left">
            <div className="api-badge-pill">
              <span className="live-dot" /> Cloudflare Test Pages Edge Gateway Live
            </div>
            <h1 className="api-master-title">
              Cloudflare Test Pages API — MongoDB Diagnostic & Control Suite
            </h1>
            <p className="api-master-desc">
              এই পেজের মাধ্যমে <strong>https://topmcqbd-web-deploy-test.pages.dev</strong> এপিআই ব্যবহার করে ৬টি MongoDB ক্লাস্টারের লাইভ কানেকশন চেক এবং টেক্সট ডাটা সরাসরি Add, Edit, Delete ও Drag-and-Drop করা যাবে।
            </p>

            <div className="api-meta-row">
              <div className="meta-pill">
                <span className="mp-label">API Host:</span>
                <span className="mp-val mono">topmcqbd-web-deploy-test.pages.dev</span>
              </div>
              <div className="meta-pill">
                <span className="mp-label">Runtime:</span>
                <span className="mp-val">Cloudflare Test Pages Edge (Direct MongoDB TCP)</span>
              </div>
              <div className="meta-pill">
            ...
            <div className="copy-action-box">
              <div className="copy-box-header">
                <span className="copy-label">
                  <i className="fa-solid fa-link" style={{ marginRight: '6px', color: '#0284c7' }} />
                  ৬টি MongoDB ক্লাস্টারের লাইভ এপিআই চেক URL:
                </span>
                <button
                  type="button"
              ...
              <div className="copy-field">
                <div className="copy-url-wrapper">
                  <span className="copy-badge" style={{
                    backgroundColor: CLUSTERS.find((c) => c.id === selectedClusterUrl)?.badgeBg || '#eef2ff',
                    color: CLUSTERS.find((c) => c.id === selectedClusterUrl)?.badgeColor || '#4f46e5',
                    border: `1px solid ${CLUSTERS.find((c) => c.id === selectedClusterUrl)?.badgeBorder || '#c7d2fe'}`
                  }}>
        ...
        <DbNavBox activeRoute="/db-connection-api/db-test-pages-api" />
