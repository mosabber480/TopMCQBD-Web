...
function QuestionsComponentInternal() {
  ...
  useEffect(() => {
    ...
    const fmtUrl = categoryParam
      ? `/api/full-model-test/questions?category=${encodeURIComponent(categoryParam)}`
      : '/api/full-model-test/questions';
    ...
    fetch(fmtUrl)
      ...
      .catch((err) => {
        ...
        setError('ডাটাবেজ থেকে পূর্ণাঙ্গ মডেল টেস্টের প্রশ্ন লোড করতে সমস্যা হয়েছে!');
        setLoading(false);
      });
  }, [categoryParam]);
...
export default function FullModelQuestionsPage() {
  return (
