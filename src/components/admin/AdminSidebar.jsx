...
const defaultMenuItems = (sidebarConfigData?.menus && sidebarConfigData.menus.length > 0)
  ...
  : [
      ...
      { href: '/admin/question-bank-dashboard', icon: 'fa-solid fa-book-bookmark', label: 'প্রশ্নব্যাংক আপলোড ড্যাশবোর্ড', subMenus: [] },
      { href: '/admin/full-model-dashabord', icon: 'fa-solid fa-file-pen', label: 'পূর্ণাঙ্গ মডেল টেস্ট কন্ট্রোল', subMenus: [] },
      { href: '/admin/subjective-all-mcqs-dashabord', icon: 'fa-solid fa-layer-group', label: 'বিষয়ভিত্তিক অল এমসিকিউ', subMenus: [] },
      { href: '/admin/subjective-model-test-dashbaord', icon: 'fa-solid fa-graduation-cap', label: 'বিষয়ভিত্তিক মডেল টেস্ট', subMenus: [] },
